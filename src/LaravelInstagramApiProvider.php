...
namespace Nakukryskin\InstagramApi;

use Illuminate\Support\ServiceProvider;
use InstagramAPI\Instagram;
use Nakukryskin\InstagramApi\Facades\InstagramApi as InstagramApiFacade;
...
class LaravelInstagramApiProvider extends ServiceProvider
{
    ...
    {
        $configPath = __DIR__ . '/../config/instagram-api.php';
        $this->mergeConfigFrom($configPath, 'instagram-api');
    ...
    {
        return config_path('instagram-api.php');
    }
}